...
<body>
    <header>
        <div class="logo">
            <img src="../../assets/img_icon/granbylogo.png" alt="Logo">
            <strong>GCST Tracking System</strong>
        </div>
        <nav class="nav-links">
            <a href="InUser_home.php">Home</a>
    ...
    <div class="dropdown-menu" id="dropdown-menu">
        <a class="menu-item" href="user_profile.php"><i class="fas fa-user"></i> Profile</a>
        <a class="menu-item" href="../../utils/log_out.php"><i class="fas fa-sign-out-alt"></i> Log Out</a>
    </div>
    ...
    <script>
        ...
        async function fetchProducts(category = 'all') {
            ...
            try {
                const response = await fetch('../../utils/fetch.php');
        ...
        function handleAction(type, id) {
            ...
            fetch('../../utils/request_product.php', {
                method: 'POST',
